...
PluMA plugin that computes a rarity index using log-modulo skew (Magurran and McGill, 2011).
...
The log-modulo skew index is then generated in the output CSV file, with rows corresponding to samples and columns to indices.
